...
function rebuild(options) {
  ...
  browserifyTask({
    development: options.development,
    src: './teqtest/static/js/index.js',
    dest: './teqtest/static/js/'
  });

  cssTask({
    development: options.development,
    src: './teqtest/static/less/index.less',
    watch: './teqtest/static/less/**/*.less',
    dest: './teqtest/static/css/'
  });
}
...
gulp.task('test', function () {
  ...
  return gulp
    ...
    .on('finish', function () {
      gulp
        .src('./teqtest/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
