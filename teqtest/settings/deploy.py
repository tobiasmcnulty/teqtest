...
DATABASES['default']['NAME'] = 'teqtest_%s' % ENVIRONMENT.lower()
DATABASES['default']['USER'] = 'teqtest_%s' % ENVIRONMENT.lower()
DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

WEBSERVER_ROOT = '/var/www/teqtest/'
...
EMAIL_SUBJECT_PREFIX = '[Teqtest %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://teqtest_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/teqtest_%(ENVIRONMENT)s' % os.environ  # noqa
